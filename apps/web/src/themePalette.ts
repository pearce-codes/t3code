...
import {
  ...
  IRIS_THEME,
  OCEAN_THEME,
  T3_CHAT_THEME as UPSTREAM_T3_CHAT_THEME,
  THEME_COLOR_ROLES,
...
export const T3_CHAT_THEME_LABEL = "Pearce CRT";
...
const T3_CHAT_LIGHT_COLORS: ThemeColors = {
  ...
  toolbarControlForeground: "#3c2b08",
  toolbarControlHover: "#ecd798",
  surface: "#fbf1d2",
  surfaceRaised: "#fffdf5",
  surfaceOverlay: "#fffef9",
  text: "#3c2b08",
  textMuted: "#7b5a18",
  border: "#e6d6ad",
  input: "#dec681",
  focus: "#c78300",
  accent: "#c78300",
  accentForeground: "#211600",
  secondary: "#f0d786",
  secondaryForeground: "#4b3505",
  muted: "#ead9a8",
  mutedForeground: "#684b12",
  placeholder: "#806a3f",
  secondaryLabel: "#7b5a18",
  iconMuted: "#7b5a18",
  error: "#f7086c",
  ...
  update: "#c78300",
  updateForeground: "#684b12",
  updateSurface: "#f6e4ac",
  accentSurface: "#f5e8bf",
  accentSurfaceForeground: "#3c2b08",
  messageSurface: "#f4e3ad",
  messageForeground: "#3c2b08",
  messageAction: "#c78300",
  messageActionForeground: "#211600",
  messageActionHover: "#d69610",
  ...
  sidebar: "#f2e3b7",
  sidebarForeground: "#3c2b08",
  sidebarMutedForeground: "#7b5a18",
  sidebarControlSurface: "#f8edcd",
  sidebarRowHover: "#f8edcd",
  sidebarRowActive: "#f3df9f",
  sidebarRowSelected: "#efd58a",
  sidebarBorder: "#dfca91",
  terminalBackground: "#fff9e8",
  terminalForeground: "#3c2b08",
  terminalCursor: "#c78300",
  terminalSelection: "#f0d786",
  terminalScrollbar: "#dec681",
  terminalScrollbarHover: "#c9a94f",
};
...
const T3_CHAT_DARK_COLORS: ThemeColors = {
  ...
  chrome: "#151106",
  toolbar: "#151106",
  toolbarForeground: "#ffe7a3",
  toolbarBorder: "#3b2d0d",
  toolbarControl: "#282006",
  toolbarControlForeground: "#f2c75c",
  toolbarControlHover: "#3a2d08",
  ...
  accentForeground: "#211600",
  secondary: "#2f2508",
  secondaryForeground: "#f2c75c",
  muted: "#3d310f",
  mutedForeground: "#d8bd72",
  placeholder: "#a58c4d",
  secondaryLabel: "#c9a94f",
  iconMuted: "#c9a94f",
  error: "#9d174d",
  ...
  update: "#f4b942",
  updateForeground: "#ffe7a3",
  updateSurface: "#3a2a04",
  accentSurface: "#3a2d08",
  accentSurfaceForeground: "#ffe7a3",
  messageSurface: "#282006",
  messageForeground: "#ffe7a3",
  messageAction: "#f4b942",
  messageActionForeground: "#211600",
  messageActionHover: "#d99a18",
  ...
  sidebar: "#0e0b02",
  sidebarForeground: "#ffe7a3",
  sidebarMutedForeground: "#b69a53",
  sidebarControlSurface: "#1d1705",
  sidebarRowHover: "#241c05",
  sidebarRowActive: "#302507",
  sidebarRowSelected: "#3a2d08",
  ...
  terminalBackground: "#0b0902",
  terminalForeground: "#f4b942",
  terminalCursor: "#ffe7a3",
  terminalSelection: "#3a2d08",
  terminalScrollbar: "#302507",
  terminalScrollbarHover: "#4b3b10",
};
...
const T3_CODE_LIGHT_THEME_COLORS: ThemeColors = {
  ...
  chrome: "#d9dad5",
  toolbar: "#c9cbc6",
  toolbarForeground: "#242520",
  toolbarBorder: "#aeb0a9",
  toolbarControl: "#f1f1ec",
  toolbarControlForeground: "#242520",
  toolbarControlHover: "#bfc1bb",
  surface: "#e8e9e4",
  surfaceRaised: "#e7e8e3",
  surfaceOverlay: "#f1f1ec",
  text: "#242520",
  textMuted: "#60625b",
  border: "#aeb0a9",
  input: "#8d9087",
  focus: "#765000",
  accent: "#765000",
  accentForeground: "#fff4d0",
  secondary: "#d0d2cc",
  secondaryForeground: "#242520",
  muted: "#ced0ca",
  mutedForeground: "#60625b",
  placeholder: "#60625b",
  secondaryLabel: "#60625b",
  iconMuted: "#60625b",
  error: "#fb2c36",
  ...
  updateSurface: "#ded4b4",
  accentSurface: "#bfc1bb",
  accentSurfaceForeground: "#242520",
  messageSurface: "#ced0ca",
  messageForeground: "#242520",
  messageAction: "#765000",
  messageActionForeground: "#fff4d0",
  messageActionHover: "#8f650e",
  codeBackground: "#e2e3de",
  codeForeground: "#242520",
  sidebar: "#c4c6c1",
  sidebarForeground: "#242520",
  sidebarMutedForeground: "#60625b",
  sidebarControlSurface: "#b5b8b1",
  sidebarRowHover: "#d4d6d0",
  sidebarRowActive: "#e6e7e2",
  sidebarRowSelected: "#ded4b4",
  sidebarBorder: "#aeb0a9",
  terminalBackground: "#151410",
  terminalForeground: "#f0d98e",
  terminalCursor: "#f6b93d",
  terminalSelection: "#4a3828",
  terminalScrollbar: "#4b4035",
  terminalScrollbarHover: "#6a5947",
};
...
const T3_CODE_DARK_THEME_COLORS: ThemeColors = {
  ...
  chrome: "#120f0d",
  toolbar: "#191411",
  toolbarForeground: "#eee5d3",
  toolbarBorder: "#392b21",
  toolbarControl: "#271f19",
  toolbarControlForeground: "#eee5d3",
  toolbarControlHover: "#30251d",
  surface: "#1e1814",
  surfaceRaised: "#251d18",
  surfaceOverlay: "#271f19",
  text: "#eee5d3",
  textMuted: "#aa9b87",
  border: "#392b21",
  input: "#4a3828",
  focus: "#f6b93d",
  accent: "#f6b93d",
  accentForeground: "#251b0d",
  secondary: "#251d18",
  secondaryForeground: "#eee5d3",
  muted: "#251d18",
  mutedForeground: "#aa9b87",
  placeholder: "#8f806e",
  secondaryLabel: "#aa9b87",
  iconMuted: "#aa9b87",
  error: "#fb414a",
  ...
  update: "#d9a43b",
  updateForeground: "#f6c75f",
  updateSurface: "#30240f",
  accentSurface: "#30251d",
  accentSurfaceForeground: "#f4ead8",
  messageSurface: "#251d18",
  messageForeground: "#eee5d3",
  messageAction: "#f6b93d",
  messageActionForeground: "#251b0d",
  messageActionHover: "#d9a43b",
  codeBackground: "#14110f",
  codeForeground: "#e8dcc5",
  sidebar: "#110f0d",
  sidebarForeground: "#eee5d3",
  sidebarMutedForeground: "#aa9b87",
  sidebarControlSurface: "#1b1613",
  sidebarRowHover: "#211a16",
  sidebarRowActive: "#2a211a",
  sidebarRowSelected: "#30251d",
  sidebarBorder: "#34281f",
  terminalBackground: "#100e0c",
  terminalForeground: "#e8dcc5",
  terminalCursor: "#f6b93d",
  terminalSelection: "#4a3828",
  terminalScrollbar: "#34281f",
  terminalScrollbarHover: "#59422d",
};
...
const BUILT_IN_THEME_DEFINITIONS: ReadonlyArray<ThemeDefinition> = BUILT_IN_THEMES.map(
  (definition) => (definition.id === T3_CHAT_THEME_ID ? T3_CHAT_THEME : definition),
);
