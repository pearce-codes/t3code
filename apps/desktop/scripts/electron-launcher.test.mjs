...
describe("electron development launcher", () => {
  ...
  it("keeps the native Electron executable name inside the branded macOS bundle", () => {
    const paths = resolveMacLauncherPaths(
      "/repo/apps/desktop/.electron-runtime/Pearce Codes (Dev).app",
      "Pearce Codes (Dev)",
    );

    assert.equal(paths.launcherExecutableName, "Pearce Codes (Dev) Launcher");
    assert.equal(
      paths.launcherBinaryPath,
      "/repo/apps/desktop/.electron-runtime/Pearce Codes (Dev).app/Contents/MacOS/Pearce Codes (Dev) Launcher",
    );
    assert.equal(
      paths.runtimeElectronBinaryPath,
      "/repo/apps/desktop/.electron-runtime/Pearce Codes (Dev).app/Contents/MacOS/Electron",
    );
    ...
    assert.include(
      script,
      "exec '/repo/apps/desktop/.electron-runtime/Pearce Codes (Dev).app/Contents/MacOS/Electron'",
    );
