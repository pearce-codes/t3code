...
const DEVELOPMENT_ASSETS = {
  ...
  androidAdaptiveBackgroundColor: "#251C1B",
  androidMonochromeIcon: "./assets/android-icon-mark.png",
  androidNotificationIcon: "./assets/android-notification-icon.png",
  androidNotificationColor: "#F6B93D",
} as const;
    ...
    widgets: [
      {
        ...
        description: "Shows the current state of active Pearce Codes agents.",
...
const config: ExpoConfig = {
  ...
  ios: {
    ...
    infoPlist: {
      ...
      NSLocalNetworkUsageDescription:
        "Allow Pearce Codes to connect to coding-agent servers on your local network or tailnet.",
  ...
  plugins: [
    ...
    [
      ...
      {
        cameraPermission:
          "Allow Pearce Codes to access your camera so you can scan pairing QR codes.",
